 ...
 *                                         avec l'affichage des projetes dans la liste déroulante
 */
...
/**
 *                                                                  AJOUT
 *                                                      route pour l'ajout des projetes
 */
...
/**
 *                                                                 MODIFICATION
 *                                                    route pour modifier une projete
 */
$app->post('/projet/edit', "freelancerppe\Controller\ProjetController::editProjetAction")->bind('projet_edit');
/**
 *                                                                SUPPRESSION
 *                                                route pour la suppression d'un projet par l'id
 */
$app->match('/projet_delete', "freelancerppe\Controller\ProjetController::deleteProjetIndexAction")->bind('projet_delete');
$app->post('/projet_delete/id', "freelancerppe\Controller\ProjetController::deleteProjetAction")->bind('projet_deleted');
